...
public final class FindMeetingQueryTest {
  ...
  /** Tests for optional attendees feature. */

  @Test
  public void onlyMandatoryAttendeesAreConsideredWithSingleOptionalAttendee() {
    // Have each mandatory person have different events. 
    // In addition, our optional person has an all-day event.
    // We should see three options because the optional attendee cannot be considered,
    // and each mandatory person has split the restricted times.
    //
    // Events  :       |--A--|     |--B--|
    //           |--------------C--------------|
    // Day     : |-----------------------------|
  ...
  @Test
  public void everyAttendeeIsConsideredWithSingleOptionalAttendee() {
    // Have each mandatory person have different events. 
    // In addition, our optional person has another event.
  ...
  @Test
  public void justEnoughRoomWithSingleOptionalAttendee() {
    // Have one mandatory person, but make it so that there is just enough room at one point in the day to
    // have the meeting.
    // In addition, there is one optional person, who cannot be considered since his 15 mins events ruins 
    // the only possible time range for the mandatory person.
    //
    // Events  : |--A--|     |----A----|
    //         :       |-B-|
    // Day     : |---------------------|
  ...
  @Test
  public void onlyOptionalAttendeesWithNoGap() {
    // Only two optional attendeess without a gap. 
    // Query should return that the whole day is available since 
    // the optional attendees cannot be accommodated and the mandatory ones (all zero of them) 
    // are free all day.
    //
    // Events  : |--A--|     |----A----|
    // Day     : |---------------------|
